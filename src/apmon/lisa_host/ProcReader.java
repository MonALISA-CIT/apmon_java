...
public class ProcReader {
     ...
     */
    public ProcReader() {
        netIn = new Hashtable<String, String>();
        dnetIn = new Hashtable<String, Long>();
        netOut = new Hashtable<String, String>();
        dnetOut = new Hashtable<String, Long>();
        exec = new cmdExec();
        parser = new Parser();
        states = new Hashtable<String, Integer>();
        netSockets = new Hashtable<String, Integer>();
        netTcpDetails = new Hashtable<String, Integer>();
